  ...
  const getPatients = async () => {
    try {
      ...
      const response = await axios.get(
        `${apiUrl}/hospitals/${params.hospitalId}/doctors/${params.doctorId}/patients`,
        {
  ...
  const handleDelete = async (Id: any) => {
    try {
      const { data } = await axios.delete(
        `${apiUrl}/hospitals/${hospitalContext?.id}/patients/${Id}`,
        {
          withCredentials: true,
        }
      );
      ...
      <Box className={styles['building_container']}>
        ...
        >
          ...
          <Button
            ...
            // }}
            onClick={() => navigate(`/hospitals/${params.hospitalId}/doctors/${params.doctorId}/patients/add`)}
          >
            {' '}
