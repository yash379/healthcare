...
export function PatientDetail(props: PatientDetailProps) {
  ...
  const getpatientinfo = async () => {
    ...
    try {
      ...
      const response = await axios.get(`${apiUrl}/hospitals/${hospitalcontext?.id}/doctors/${params.doctorId}/patient/${params.patientId}`, {
  ...
  const handleClick = () => {
    navigate(`/hospitals/${hospitalcontext?.id}/doctors/${params.doctorId}/patients/${params.patientId}/medical-history`);
  };

  const handleStartDiagnosisClick = () => {
    navigate(`/hospitals/${hospitalcontext?.id}/doctors/${params.doctorId}/patients/${params.patientId}/diagnosis`);
  };
