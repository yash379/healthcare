export const CountriesStates: {
    ...
    { name: 'Anguilla', code: 'AI', phone_code: '+1-264', states: [] },
    { name: 'Antarctica', code: 'AQ', phone_code: '672', states: [] },
    {
    ...
    { name: 'Aruba', code: 'AW', phone_code: '297', states: [] },
    {
      name: 'Australia',
      code: 'AU',
      phone_code: '61',
    ...
    { name: 'Bouvet Island', code: 'BV', phone_code: '0055', states: [] },
    {
      name: 'Brazil',
      code: 'BR',
      phone_code: '55',
    ...
    { name: 'Cook Islands', code: 'CK', phone_code: '682', states: [] },
    {
      name: 'Costa Rica',
      code: 'CR',
      phone_code: '506',
    ...
    { name: 'Curaçao', code: 'CW', phone_code: '599', states: [] },
    {
      name: 'Cyprus',
      code: 'CY',
      phone_code: '357',
    ...
    { name: 'Faroe Islands', code: 'FO', phone_code: '298', states: [] },
    {
      name: 'Fiji Islands',
      code: 'FJ',
      phone_code: '679',
    ...
    { name: 'French Guiana', code: 'GF', phone_code: '594', states: [] },
    {
    ...
    { name: 'Gibraltar', code: 'GI', phone_code: '350', states: [] },
    {
      name: 'Greece',
      code: 'GR',
      phone_code: '30',
    ...
    { name: 'Greenland', code: 'GL', phone_code: '299', states: [] },
    {
      name: 'Grenada',
      code: 'GD',
      phone_code: '+1-473',
    ...
    { name: 'Guadeloupe', code: 'GP', phone_code: '590', states: [] },
    { name: 'Guam', code: 'GU', phone_code: '+1-671', states: [] },
    {
      name: 'Guatemala',
      code: 'GT',
      phone_code: '502',
    ...
    { name: 'Jersey', code: 'JE', phone_code: '+44-1534', states: [] },
    {
      name: 'Jordan',
      code: 'JO',
      phone_code: '962',
    ...
    { name: 'Macau S.A.R.', code: 'MO', phone_code: '853', states: [] },
    {
      name: 'Macedonia',
      code: 'MK',
      phone_code: '389',
    ...
    { name: 'Martinique', code: 'MQ', phone_code: '596', states: [] },
    {
      name: 'Mauritania',
      code: 'MR',
      phone_code: '222',
    ...
    { name: 'Mayotte', code: 'YT', phone_code: '262', states: [] },
    {
      name: 'Mexico',
      code: 'MX',
      phone_code: '52',
    ...
    { name: 'Montserrat', code: 'MS', phone_code: '+1-664', states: [] },
    {
      name: 'Morocco',
      code: 'MA',
      phone_code: '212',
    ...
    { name: 'New Caledonia', code: 'NC', phone_code: '687', states: [] },
    {
      name: 'New Zealand',
      code: 'NZ',
      phone_code: '64',
    ...
    { name: 'Niue', code: 'NU', phone_code: '683', states: [] },
    { name: 'Norfolk Island', code: 'NF', phone_code: '672', states: [] },
    {
      name: 'North Korea',
      code: 'KP',
      phone_code: '850',
    ...
    { name: 'Reunion', code: 'RE', phone_code: '262', states: [] },
    {
      name: 'Romania',
      code: 'RO',
      phone_code: '40',
    ...
    { name: 'Saint Helena', code: 'SH', phone_code: '290', states: [] },
    {
    ...
    { name: 'South Georgia', code: 'GS', phone_code: '500', states: [] },
    {
      name: 'South Korea',
      code: 'KR',
      phone_code: '82',
    ...
    { name: 'Tokelau', code: 'TK', phone_code: '690', states: [] },
    {
      name: 'Tonga',
      code: 'TO',
      phone_code: '676',
    ...
    { name: 'Western Sahara', code: 'EH', phone_code: '212', states: [] },
    {
      name: 'Yemen',
      code: 'YE',
      phone_code: '967',
