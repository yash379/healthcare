      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-around' }}>
        ...
        <Box key={patient?.id} sx={{ marginBottom: 2, marginTop: 1, marginLeft: -2, width: '40%' }}>
          ...
          >
            ...
            >
              {/* Check if both firstName and lastName exist before displaying initials */}
              {patient?.firstName && patient?.lastName
                ? `${patient.firstName[0]}${patient.lastName[0]}` // Show first initial of firstName and lastName
                : patient?.firstName?.[0]} {/* Fallback to just firstName initial */}
            </Avatar>
            {/* Patient ID */}
