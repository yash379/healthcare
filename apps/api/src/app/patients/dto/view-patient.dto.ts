...
export class ViewPatientAllDetailsDto {
  @ApiProperty() id: number;
  @ApiProperty() firstName: string;
  @ApiProperty() lastName: string;
  @ApiProperty() email: string;
  ...
  @ApiProperty() doctorFirstName: string;
  @ApiProperty() doctorLastName: string;
  @ApiProperty() doctorEmail: string;
  @ApiProperty() doctorPhoneNumber: string;
  @ApiProperty() hospitalRoles: ViewHospitalRoleDto[];
  @ApiProperty() superRole?: SuperRoleName;
  @ApiProperty() isActive: boolean;
}
